...
public class BoardView extends VBox implements ViewObserver {
    ...
    public BoardView(@NotNull GameController gameController) {
        ...
        // XXX A6a: create the space event handler for delegating the
        //        click on a space to the moveCurrentPlayertoSpace() method
        //        of the GameController and attach the handler to all spaces
