...
public class RoboRally extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        // create the primary scene with the menubar and a pane for
    ...
    public void createGameSelectionView(OnlineController onlineController) {
        // if present, remove old BoardView
        boardRoot.getChildren().clear();
        stage.sizeToScene();
        ...
        if (onlineController != null) {
            // create and add view for new board
            GameSelection gameSelection = new GameSelection(onlineController);
